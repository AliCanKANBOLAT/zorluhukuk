        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0 flex flex-col items-center text-center md:text-left">
            ...
            <div className="flex flex-col space-y-1 text-sm md:text-base">
              ...
              <p>
                Telefon: <a href="tel:+905057462404" className="text-cyan-400 hover:underline">+90 505 746 2404</a>
              </p>
              <p>
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-cyan-400 text-xl">
          ...
          <div className="w-full md:w-1/3 text-center md:text-right">
            ...
            <p className="text-sm md:text-base mb-1">&copy; 2024 Hukuk Bürosu. Tüm hakları saklıdır.</p>
